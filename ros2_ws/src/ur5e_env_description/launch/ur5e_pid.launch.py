...
def generate_launch_description():
    ...
    mujoco = Node(
        ...
        remappings=[
        # remapeia o tópico interno de joint_states para o global
        ("/mujoco_plugin/joint_states", "/joint_states")
    ],
    output="screen"
    )
    ...
    return LaunchDescription([rsp, mujoco, spawner_jsb, spawner_arm, pid_matlab, main_node, vision_node])
